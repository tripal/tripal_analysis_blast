...
<div class="tripal_analysis_blast-info-box-desc tripal-info-box-desc"></div><?php 
...
$rows[] = array(
  array(
    'data' => 'Blast Arguments',
    'header' => TRUE
  ),
  $blast->blastparameters
);
...
$table = array(
  ...
  'rows' => $rows,
  'attributes' => array(
    'id' => 'tripal_analysis_blast-table-base',
  ),
  'sticky' => FALSE,
  'caption' => '',
  'colgroups' => array(),
